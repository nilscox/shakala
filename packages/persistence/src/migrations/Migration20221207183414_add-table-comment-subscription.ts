...
export class Migration20221207183414 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "comment_subscription" add constraint "comment_subscription_comment_id_user_id_unique" unique ("comment_id", "user_id");');
