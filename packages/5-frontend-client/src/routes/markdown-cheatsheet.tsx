...
export const MarkdownCheatsheetRoute = () => (
  <>
    ...
    <p>
      ...
      permet d'afficher des liens, du texte en gras, des listes, etc. Voici une petite liste des mises en
      formes usuelles, dont vous pourriez avoir besoin. Visitez{' '}
      <ExternalLink href="https://learnxinyminutes.com/docs/fr-fr/markdown-fr/">ce site</ExternalLink> pour
      plus de details sur cette syntaxe.
    </p>

    <p>
      Si vous pensez qu'il serait intéressant d'ajouter d'autres fonctionnalités de mise en forme, n'hésitez
      pas à <Link to="/faq#contact">proposer vos idées</Link> !
    </p>
...
`.trim()}
    ...
    <SyntaxRule name="Emoji" example="Bien vu :+1: :slightly_smiling_face:">
      Les noms des émojis sont les "shortcodes" standards, en anglais. Vous pouvez également utiliser les
      caractères émojis directement.
    </SyntaxRule>
  </>
);
